...
// used to reduce problems to simpler forms. From computing averages to sorting, any array 
// operation can be achieved by applying it. Recall that map and filter are special cases of reduce.

// Many content management sites (CMS) have the titles of a post added to part of the URL for simple
//  bookmarking purposes. For example, if you write a Medium post titled "Stop Using Reduce", it's 
//  likely the URL would have some form of the title string in it (".../stop-using-reduce"). You may 
...
// the URL. You can use any of the methods covered in this section, and don't use replace. Here are 
// the requirements:
