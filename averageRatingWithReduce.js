...
// between two different elements of the array. For example, if you want to compare elements 
// of the array, or add them together, filter or map could not process that.

// The reduce method allows for more general forms of array processing, and it's possible to 
// show that both filter and map can be derived as a special application of reduce.
...
const total = watchList.filter(entry => entry.Director == 'Christopher Nolan')
                            .map(film => parseFloat(film.imdbRating))
                            .reduce((accumulator, currentValue) => accumulator + currentValue);

var averageRating = total / 4;
