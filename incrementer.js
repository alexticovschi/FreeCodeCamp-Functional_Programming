...
//  call in the tabClose() function. Unfortunately, splice changes the original array it is called 
//  on, so the second call to it used a modified array, and gave unexpected results.
...
// One of the core principle of functional programming is to not change things. Changes lead to 
// bugs. It's easier to prevent bugs knowing that your functions don't change anything, including 
// the function arguments or any global variable.
...
// Recall that in functional programming, changing or altering things is called mutation, and
// the outcome is called a side effect. A function, ideally, should be a pure function, meaning
